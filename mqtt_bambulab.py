...
def processMessage(data):
  ...
  if "print" in data:    
    ...
    if "command" in data["print"] and data["print"]["command"] == "project_file" and "url" in data["print"]:
      ...
      print_id = insert_print(PRINTER_STATE["print"]["subtask_name"], "cloud", PENDING_PRINT_METADATA["image"],None,PENDING_PRINT_METADATA["duration"])
    ...
    if ( "print_type" in PRINTER_STATE["print"] and PRINTER_STATE["print"]["print_type"] == "local" and
      ...
      if (
        ...
        print_id = insert_print(PENDING_PRINT_METADATA["file"], PRINTER_STATE["print"]["print_type"], PENDING_PRINT_METADATA["image"],None,PENDING_PRINT_METADATA["duration"])
